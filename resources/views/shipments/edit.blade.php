...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-shipping-fast"></i> Editar Despacho #{{ $shipment->shipment_number }}</h2>
                ...
                <form action="{{ route('shipments.update', $shipment->id) }}" method="POST">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('contract_id') is-invalid @enderror" id="contract_id" name="contract_id" required>
                                ...
                                @forelse($contracts as $contract)
                                    <option value="{{ $contract->id }}" {{ old('contract_id', $shipment->contract_id) == $contract->id ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('shipping_line_id') is-invalid @enderror" id="shipping_line_id" name="shipping_line_id">
                                ...
                                @forelse($shippingLines as $line)
                                    <option value="{{ $line->id }}" {{ old('shipping_line_id', $shipment->shipping_line_id) == $line->id ? 'selected' : '' }}>
                                        {{ $line->name }} ({{ $line->code }})
                                    </option>
                                @empty
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control @error('scheduled_date') is-invalid @enderror"
                                   id="scheduled_date" name="scheduled_date" value="{{ old('scheduled_date', $shipment->scheduled_date ? $shipment->scheduled_date->format('Y-m-d') : '') }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                <option value="scheduled" {{ old('status', $shipment->status) === 'scheduled' ? 'selected' : '' }}>Programado</option>
                                <option value="in_transit" {{ old('status', $shipment->status) === 'in_transit' ? 'selected' : '' }}>En Tránsito</option>
                                <option value="at_customs" {{ old('status', $shipment->status) === 'at_customs' ? 'selected' : '' }}>En Aduana</option>
                                <option value="loaded" {{ old('status', $shipment->status) === 'loaded' ? 'selected' : '' }}>Cargado</option>
                                <option value="shipped" {{ old('status', $shipment->status) === 'shipped' ? 'selected' : '' }}>Embarcado</option>
                                <option value="completed" {{ old('status', $shipment->status) === 'completed' ? 'selected' : '' }}>Completado</option>
                                <option value="cancelled" {{ old('status', $shipment->status) === 'cancelled' ? 'selected' : '' }}>Cancelado</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('plant_pickup_company') is-invalid @enderror" id="plant_pickup_company" name="plant_pickup_company">
                                ...
                                <option value="SPS" {{ old('plant_pickup_company', $shipment->plant_pickup_company) == 'SPS' ? 'selected' : '' }}>SPS</option>
                                <option value="DUS" {{ old('plant_pickup_company', $shipment->plant_pickup_company) == 'DUS' ? 'selected' : '' }}>DUS</option>
                            </select>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('customs_loading_company') is-invalid @enderror" id="customs_loading_company" name="customs_loading_company">
                                <option value="">Seleccione</option>
                                <option value="SPS" {{ old('customs_loading_company', $shipment->customs_loading_company) == 'SPS' ? 'selected' : '' }}>SPS</option>
                                <option value="DUS" {{ old('customs_loading_company', $shipment->customs_loading_company) == 'DUS' ? 'selected' : '' }}>DUS</option>
                            </select>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('transport_company_id') is-invalid @enderror" id="transport_company_id" name="transport_company_id">
                                ...
                                @foreach($logisticsCompanies as $company)
                                    <option value="{{ $company->id }}" {{ old('transport_company_id', $shipment->transport_company_id) == $company->id ? 'selected' : '' }}>
                                        {{ $company->name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <input type="text" class="form-control mt-1 @error('transport_company') is-invalid @enderror"
                                   id="transport_company" name="transport_company" value="{{ old('transport_company', $shipment->transport_company) }}" placeholder="Empresa manual">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('transport_contact') is-invalid @enderror"
                                   id="transport_contact" name="transport_contact" value="{{ old('transport_contact', $shipment->transport_contact) }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('transport_phone') is-invalid @enderror"
                                   id="transport_phone" name="transport_phone" value="{{ old('transport_phone', $shipment->transport_phone) }}" 
                                   pattern="^\+[0-9]{11}$" 
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control @error('transport_email') is-invalid @enderror"
                                   id="transport_email" name="transport_email" value="{{ old('transport_email', $shipment->transport_email) }}" 
                                   autocomplete="email"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('transport_request_number') is-invalid @enderror"
                               id="transport_request_number" name="transport_request_number" value="{{ old('transport_request_number', $shipment->transport_request_number) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control @error('truck_cost') is-invalid @enderror"
                               id="truck_cost" name="truck_cost" value="{{ old('truck_cost', $shipment->truck_cost) }}">
                        @error('truck_cost')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('plant_pickup_scheduled') is-invalid @enderror"
                                   id="plant_pickup_scheduled" name="plant_pickup_scheduled" value="{{ old('plant_pickup_scheduled', $shipment->plant_pickup_scheduled ? $shipment->plant_pickup_scheduled->format('Y-m-d\TH:i') : '') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('customs_loading_scheduled') is-invalid @enderror"
                                   id="customs_loading_scheduled" name="customs_loading_scheduled" value="{{ old('customs_loading_scheduled', $shipment->customs_loading_scheduled ? $shipment->customs_loading_scheduled->format('Y-m-d\TH:i') : '') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('transport_departure_scheduled') is-invalid @enderror"
                                   id="transport_departure_scheduled" name="transport_departure_scheduled" value="{{ old('transport_departure_scheduled', $shipment->transport_departure_scheduled ? $shipment->transport_departure_scheduled->format('Y-m-d\TH:i') : '') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('port_arrival_scheduled') is-invalid @enderror"
                                   id="port_arrival_scheduled" name="port_arrival_scheduled" value="{{ old('port_arrival_scheduled', $shipment->port_arrival_scheduled ? $shipment->port_arrival_scheduled->format('Y-m-d\TH:i') : '') }}">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <button type="submit" class="btn btn-success">Actualizar Despacho</button>
                    </div>
                </form>

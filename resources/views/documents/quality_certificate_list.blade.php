...
<div class="container">
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2><i class="fas fa-certificate"></i> Certificado de Calidad</h2>
                <div>
                    <a href="{{ route('documents.quality-certificate.create') }}" class="btn btn-success me-2">
    ...
    <div class="alert alert-info">
        <i class="fas fa-info-circle"></i> <strong>Selecciona un contrato para generar el Certificado de Calidad</strong><br>
        <small>Podrás editar los datos antes de generar el PDF final.</small>
    </div>
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('documents.quality-certificate.edit', $contract->id) }}" class="btn btn-success w-100">
                            <i class="fas fa-edit"></i> Generar Certificado
                        </a>
                    </div>
                </div>
            </div>

                ...
                <form action="{{ route('clients.update', $client->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                            ...
                            <option value="constant" {{ old('type', $client->type) === 'constant' ? 'selected' : '' }}>Constante (con historial)</option>
                            <option value="new" {{ old('type', $client->type) === 'new' ? 'selected' : '' }}>Nuevo</option>
                        </select>
                        @error('type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror

...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-user-tie"></i> Crear Nuevo Broker</h2>
                ...
                <form action="{{ route('brokers.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" min="1.5" max="3.0" class="form-control @error('commission_percentage') is-invalid @enderror"
                               id="commission_percentage" name="commission_percentage" value="{{ old('commission_percentage') }}" required>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <button type="submit" class="btn btn-success">Guardar Broker</button>
                    </div>
                </form>
            </div>
        </div>

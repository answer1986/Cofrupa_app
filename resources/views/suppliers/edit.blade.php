        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control @error('bank_account_type') is-invalid @enderror"
                                ...
                                <option value="corriente" {{ old('bank_account_type', $supplier->bank_account_type) == 'corriente' ? 'selected' : '' }}>Cuenta Corriente</option>
                                <option value="vista" {{ old('bank_account_type', $supplier->bank_account_type) == 'vista' ? 'selected' : '' }}>Cuenta Vista</option>
                                <option value="ahorro" {{ old('bank_account_type', $supplier->bank_account_type) == 'ahorro' ? 'selected' : '' }}>Cuenta de Ahorro</option>
                            </select>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('bank_account_number') is-invalid @enderror"
                                   id="bank_account_number" name="bank_account_number" value="{{ old('bank_account_number', $supplier->bank_account_number) }}"
                    ...
                    <hr class="my-4">
                    <h5 class="mb-3"><i class="fas fa-chart-line"></i> Información Financiera (Solo Lectura)</h5>
                    <div class="row">
                        <div class="col-md-6 mb-3">

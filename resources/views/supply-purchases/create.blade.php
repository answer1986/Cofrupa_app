...
<div class="container-fluid">
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <h2><i class="fas fa-shopping-bag"></i> Nueva Compra de Insumos</h2>
    ...
    @if($errors->any())
        <div class="alert alert-danger alert-dismissible fade show">
            <strong><i class="fas fa-exclamation-triangle"></i> No se pudo guardar. Revise los errores:</strong>
            <ul class="mb-0 mt-2">
    ...
    <form action="{{ route('supply-purchases.store') }}" method="POST" id="supplyPurchaseForm">
        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('buyer') is-invalid @enderror" id="buyer" name="buyer" required>
                                    ...
                                    <option value="Cofrupa" {{ old('buyer', 'Cofrupa') == 'Cofrupa' ? 'selected' : '' }}>Cofrupa</option>
                                    <option value="LG" {{ old('buyer') == 'LG' ? 'selected' : '' }}>LG</option>
                                    <option value="Comercializadora" {{ old('buyer') == 'Comercializadora' ? 'selected' : '' }}>Comercializadora</option>
                                </select>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <textarea class="form-control" 
                                  ...
                                  name="notes" 
                                  rows="4" 
                                  placeholder="Observaciones generales...">{{ old('notes') }}</textarea>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-success btn-lg">
                                <i class="fas fa-save"></i> Guardar Compra de Insumos
                            </button>
                            <a href="{{ route('supply-purchases.index') }}" class="btn btn-secondary">
                                Cancelar
                            </a>
...
function initInsumosSystem() {
    ...
    addBtn.addEventListener('click', addInsumoRow);
    addInsumoRow();
